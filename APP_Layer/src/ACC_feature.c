...
static float_t FrontLastDistance = 1000.0f;
static float_t RightLastDistance = 1000.0f;
static float_t LeftLastDistance = 1000.0f;

static float_t OriginalCarSpeed = 0.0;
static float_t OriginalCarDirection = 0.0;
